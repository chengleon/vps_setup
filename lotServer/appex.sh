...
URLKernel='https://github.com/chengleon/vps_setup/raw/master/lotServer/kernel/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://github.com/chengleon/vps_setup/raw/master/lotServer/kernel/$MyKernel"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://github.com/chengleon/vps_setup/raw/master/lotServer/appex.zip"
